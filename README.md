...
#### 🏥 [Happy Feet Veterinaria](https://github.com/Brayanmantilla/nombre-repo)
Sistema integral de gestión veterinaria con 27 tablas relacionales
- **Stack:** Java, Spring Boot, JPA/Hibernate, PostgreSQL
- Gestión completa de citas, historiales médicos e inventario
- Sistema de fidelización de clientes

#### 📦 [LogiTrack](https://github.com/Brayanmantilla/nombre-repo)
Sistema de gestión de almacenes con autenticación JWT
- **Stack:** Java, Spring Boot, MySQL, Spring Security, JWT
- API RESTful con control de inventarios
- Arquitectura en capas siguiendo principios SOLID

#### 📅 [Sistema de Agendamiento](https://github.com/Brayanmantilla/nombre-repo)
Aplicación empresarial para gestión de eventos
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/brayan-javier-mantilla-mendoza/)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:brayan21120409@gmail.com)

📍 **Ubicación:** Piedecuesta, Santander, Colombia  
💼 **Disponible para:** Trabajo remoto, híbrido o presencial  
🎯 **Buscando:** Oportunidades como Desarrollador Junior/Semi-Senior

---

⭐️ *"La tecnología debe servir a las personas, no al revés"*
